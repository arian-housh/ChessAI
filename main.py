...
piece_square_tables = {
    chess.PAWN: [
        ...
        40, 40, 50, 100, 100, 50, 40, 40,
        50, 50, 60, 110, 110, 60, 50, 50,
        60, 60, 70, 200, 200, 70, 60, 60,
        0, 0, 0, 0, 0, 0, 0, 0
    ]
    ,
    chess.KNIGHT: [
    ...
    chess.BISHOP: [
        -10, -5, -5, -5, -5, -5, -5, -10,
        -5, 50, 25, 50, 50, 25, 50, -5,
        -5, 50, 75, 100, 100, 75, 50, -5,
        -5, 50, 100, 125, 125, 100, 50, -5,
        -5, 50, 100, 125, 125, 100, 50, -5,
        -5, 50, 75, 100, 100, 75, 50, -5,
        -5, 50, 25, 50, 50, 25, 50, -5,
        -10, -5, -5, -5, -5, -5, -5, -10
        ...
        while running:
            if not player_turn and not game_over:
                try:
                    ...
                    best_move, depth_searched = computer_move(board, 10, openings, 10)
                    if best_move is not None:
